...
export const ITEM_TEMPLATES: Record<string, Item> = {
  ...
  health_potion_small: {
    ...
    description: 'Restores 50 HP to one hero',
    rarity: Rarity.Common,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [{ stat: 'hp', type: 'add', value: 50 }],
    icon: ICON_PATHS.heart,
    spritePath: ICON_PATHS.heart,
    cost: 25,
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Instant heal 50 HP',
  },

  mana_potion_small: {
    id: 'mana_potion_small',
    name: 'Small Energy Potion',
    description: 'Reduces cooldowns by 50%',
    rarity: Rarity.Common,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [{ stat: 'cooldown', type: 'multiply', value: 0.5 }],
    icon: ICON_PATHS.blueBottle,
    spritePath: ICON_PATHS.blueBottle,
    cost: 25,
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Reduces all cooldowns by 50%',
  },
  ...
  antidote: {
    ...
    type: 'consumable' as const,
    effects: [],
    icon: ICON_PATHS.greenBottle,
    spritePath: ICON_PATHS.greenBottle,
    cost: 20,
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Removes poison and disease status effects',
  },
  ...
  health_potion_medium: {
    ...
    description: 'Restores 100 HP to one hero',
    rarity: Rarity.Uncommon,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [{ stat: 'hp', type: 'add', value: 100 }],
    icon: ICON_PATHS.heart,
    spritePath: ICON_PATHS.heart,
    cost: 75,
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Instant heal 100 HP',
  },

  strength_potion: {
    id: 'strength_potion',
    name: 'Strength Potion',
    description: 'Increases damage by 50% for next wave',
    rarity: Rarity.Uncommon,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [{ stat: 'damage', type: 'multiply', value: 1.5, duration: 1 }],
    icon: ICON_PATHS.blueBottle,
    spritePath: ICON_PATHS.blueBottle,
    cost: 100,
    slot: 'consumable',
    consumable: true,
    specialEffect: '+50% damage for next wave',
  },

  speed_potion: {
    id: 'speed_potion',
    name: 'Swiftness Potion',
    description: 'Increases speed by 30% for next wave',
    rarity: Rarity.Uncommon,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [{ stat: 'speed', type: 'multiply', value: 1.3, duration: 1 }],
    icon: ICON_PATHS.greenBottle,
    spritePath: ICON_PATHS.greenBottle,
    cost: 100,
    slot: 'consumable',
    consumable: true,
    specialEffect: '+30% attack and movement speed for next wave',
  },

  defense_potion: {
    id: 'defense_potion',
    name: 'Ironhide Potion',
    description: 'Increases defense by 20 for next wave',
    rarity: Rarity.Uncommon,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [{ stat: 'defense', type: 'add', value: 20, duration: 1 }],
    icon: ICON_PATHS.shield,
    spritePath: ICON_PATHS.shield,
    cost: 100,
    slot: 'consumable',
    consumable: true,
    specialEffect: '+20 defense for next wave',
  },
  ...
  health_potion_large: {
    ...
    description: 'Restores 200 HP to one hero',
    rarity: Rarity.Rare,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [{ stat: 'hp', type: 'add', value: 200 }],
    icon: ICON_PATHS.heart,
    spritePath: ICON_PATHS.heart,
    cost: 200,
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Instant heal 200 HP',
  },

  regeneration_potion: {
    id: 'regeneration_potion',
    name: 'Regeneration Potion',
    description: 'Regenerate 20 HP per second for next wave',
    rarity: Rarity.Rare,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [],
    ...
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Regenerate 20 HP/sec during next wave',
  },

  berserk_potion: {
    id: 'berserk_potion',
    name: 'Berserker Elixir',
    description: 'Double damage but halve defense for next wave',
    rarity: Rarity.Rare,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [
      { stat: 'damage', type: 'multiply', value: 2.0, duration: 1 },
      { stat: 'defense', type: 'multiply', value: 0.5, duration: 1 }
    ],
    icon: ICON_PATHS.blueBottle,
    spritePath: ICON_PATHS.blueBottle,
    cost: 300,
    slot: 'consumable',
    consumable: true,
    specialEffect: '+100% damage, -50% defense for next wave',
  },

  invisibility_potion: {
    id: 'invisibility_potion',
    name: 'Invisibility Potion',
    description: 'Cannot be targeted for first 5 seconds of wave',
    rarity: Rarity.Rare,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [],
    ...
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Hero cannot be targeted for 5 seconds',
  },

  cleansing_elixir: {
    id: 'cleansing_elixir',
    name: 'Cleansing Elixir',
    description: 'Removes all debuffs and grants immunity for 3 seconds',
    rarity: Rarity.Rare,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [],
    ...
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Remove debuffs, immune to status effects for 3 seconds',
  },

  // Legendary Potions
  health_potion_full: {
    id: 'health_potion_full',
    name: 'Full Restoration Potion',
    description: 'Restores hero to full HP',
    rarity: Rarity.Legendary,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [{ stat: 'hp', type: 'set', value: 999999 }],
    icon: ICON_PATHS.heart,
    spritePath: ICON_PATHS.heart,
    cost: 500,
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Fully restore HP to maximum',
  },

  party_heal_potion: {
    id: 'party_heal_potion',
    name: 'Group Healing Elixir',
    description: 'Heals all heroes for 150 HP',
    rarity: Rarity.Legendary,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [],
    ...
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Heal all party members for 150 HP',
  },

  titan_potion: {
    id: 'titan_potion',
    name: 'Titan\'s Brew',
    description: 'Increases all stats by 25% for next wave',
    rarity: Rarity.Legendary,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [
      { stat: 'damage', type: 'multiply', value: 1.25, duration: 1 },
      { stat: 'defense', type: 'multiply', value: 1.25, duration: 1 },
      { stat: 'speed', type: 'multiply', value: 1.25, duration: 1 },
      { stat: 'maxHp', type: 'multiply', value: 1.25, duration: 1 }
    ],
    icon: ICON_PATHS.orb,
    spritePath: ICON_PATHS.orb,
    cost: 800,
    slot: 'consumable',
    consumable: true,
    specialEffect: '+25% to all stats for next wave',
  },

  time_warp_potion: {
    id: 'time_warp_potion',
    name: 'Chrono Elixir',
    description: 'Reset all cooldowns instantly',
    rarity: Rarity.Legendary,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [],
    ...
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Instantly reset all ability cooldowns',
  },
  ...
  resurrection_potion: {
    ...
    name: 'Phoenix Tears',
    description: 'Revive a fallen hero with full HP',
    rarity: Rarity.Mythic,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [],
    icon: ICON_PATHS.heart,
    spritePath: ICON_PATHS.heart,
    cost: 0, // Cannot be sold
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Revive one fallen hero to full HP',
  },

  invincibility_potion: {
    id: 'invincibility_potion',
    name: 'Divine Protection',
    description: 'Hero takes no damage for next wave',
    rarity: Rarity.Mythic,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [],
    ...
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Complete damage immunity for one wave',
  },

  miracle_elixir: {
    id: 'miracle_elixir',
    name: 'Miracle Elixir',
    description: 'Fully heal all heroes and reset all cooldowns',
    rarity: Rarity.Mythic,
    category: ItemCategory.Consumable,
    type: 'consumable' as const,
    effects: [],
    ...
    slot: 'consumable',
    consumable: true,
    specialEffect: 'Full party heal + reset all cooldowns',
  },
