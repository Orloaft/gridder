...
export const HERO_TEMPLATES: Record<string, HeroTemplate> = {
  ...
  shield_bearer: {
    ...
    abilities: [
      {
        ...
        name: 'Stone Wall',
        type: AbilityType.Defensive,
        description: 'Grants a protective shield to an ally, absorbing incoming damage',
        cooldown: 4,
        currentCooldown: 0,
        range: 2,
        effects: [
      ...
      },
      {
        ...
        name: 'Iron Skin',
        type: AbilityType.Defensive,
        description: 'Hardens skin to increase defense by 50% for 3 ticks',
        cooldown: 4,
        currentCooldown: 0,
        effects: [
          {
    ...
    spritePath: ICON_PATHS.shieldman,
    rarity: Rarity.Uncommon,
    description: 'A stalwart defender who shields allies from harm',
  ...
  executioner: {
    ...
    abilities: [
      {
        ...
        name: 'Execute',
        type: AbilityType.Offensive,
        description: 'Delivers a killing blow that deals 3x damage to enemies below 30% HP',
        cooldown: 5,
        currentCooldown: 0,
        range: 1,
        effects: [
          {
            ...
            value: 60,
            targetType: 'enemy',
            condition: 'target_below_hp_percent',
            conditionValue: 30,
      ...
      },
      {
        ...
        type: AbilityType.Offensive,
        description: 'A vicious attack that damages and slows the target',
        cooldown: 3,
        currentCooldown: 0,
        range: 1,
        effects: [
    ...
    spritePath: ICON_PATHS.bloodyKnifeman,
    rarity: Rarity.Rare,
    description: 'Deals devastating damage to weakened foes',
    tags: ['dps', 'melee', 'finisher'],
  },
  ...
  battle_priest: {
    ...
    abilities: [
      {
        ...
        name: 'Mass Heal',
        type: AbilityType.Support,
        description: 'Channels divine energy to heal all allies',
        cooldown: 4,
        currentCooldown: 0,
        range: 3,
        effects: [
      ...
      },
      {
        ...
        name: 'Rallying Cry',
        type: AbilityType.Support,
        description: 'Inspires all allies, boosting damage and speed for 3 ticks',
        cooldown: 6,
        currentCooldown: 0,
        range: 3,
        effects: [
    ...
    spritePath: ICON_PATHS.warCleric,
    rarity: Rarity.Rare,
    description: 'A holy warrior who heals allies and inspires them to fight harder',
    tags: ['healer', 'support', 'ranged'],
  },
  ...
  storm_knight: {
    ...
    abilities: [
      {
        ...
        name: 'Thunderclap',
        type: AbilityType.Offensive,
        description: 'Slams the ground with lightning force, damaging and stunning nearby enemies',
        cooldown: 5,
        currentCooldown: 0,
        range: 1,
        effects: [
    ...
    spritePath: ICON_PATHS.arcaneHalberdman,
    rarity: Rarity.Rare,
    description: 'An armored knight who channels lightning to stun nearby foes',
    tags: ['tank', 'cc', 'melee', 'aoe'],
  },
  ...
  shadowblade: {
    ...
    abilities: [
      {
        ...
        name: 'Backstab',
        type: AbilityType.Offensive,
        description: 'A swift, devastating strike from the shadows',
        cooldown: 3,
        currentCooldown: 0,
        range: 1,
        effects: [
      ...
      },
      {
        ...
        name: 'Hex',
        type: AbilityType.Support,
        description: 'Curses an enemy, reducing their damage and speed by 25% for 3 ticks',
        cooldown: 4,
        currentCooldown: 0,
        range: 2,
        effects: [
    ...
    spritePath: ICON_PATHS.darkKnifeman,
    rarity: Rarity.Rare,
    description: 'A deadly blade that weakens enemies before striking the killing blow',
    tags: ['dps', 'melee', 'debuffer'],
  },
  ...
  arch_druid: {
    ...
    abilities: [
      {
        ...
        name: 'Regeneration',
        type: AbilityType.Support,
        description: 'Blesses an ally with nature\'s vigor, regenerating health over 5 ticks',
        cooldown: 5,
        currentCooldown: 0,
        range: 3,
        effects: [
      ...
      },
      {
        ...
        name: 'Entangling Roots',
        type: AbilityType.Offensive,
        description: 'Summons roots from the ground to damage and immobilize an enemy',
        cooldown: 4,
        currentCooldown: 0,
        range: 3,
        effects: [
    ...
    spritePath: ICON_PATHS.staffCloakman,
    rarity: Rarity.Legendary,
    description: 'An ancient druid who commands nature to heal allies and ensnare foes',
    tags: ['healer', 'cc', 'ranged', 'support'],
  },
  ...
  archmage: {
    ...
    abilities: [
      {
        ...
        name: 'Meteor',
        type: AbilityType.Offensive,
        description: 'Calls down a devastating meteor that obliterates a wide area',
        cooldown: 7,
        currentCooldown: 0,
        range: 4,
        effects: [
      ...
      },
      {
        ...
        name: 'Chain Lightning',
        type: AbilityType.Offensive,
        description: 'Hurls a bolt of lightning that arcs to the target',
        cooldown: 4,
        currentCooldown: 0,
        range: 3,
        effects: [
    ...
    spritePath: ICON_PATHS.weakWizard,
    rarity: Rarity.Mythic,
    description: 'A supreme mage who commands fire and lightning to devastate the battlefield',
    tags: ['dps', 'ranged', 'aoe'],
  },
};
  ...
  gargoyle: {
    ...
    abilities: [
      ...
      },
      {
        ...
        name: 'Stone Wall',
        type: AbilityType.Defensive,
        description: 'Encases itself in a protective stone shield',
        cooldown: 5,
        currentCooldown: 0,
        effects: [
          {
  ...
  bone_colossus: {
    ...
    abilities: [
      ...
      },
      {
        ...
        name: 'Whirlwind',
        type: AbilityType.Offensive,
        description: 'Spins violently, crushing all nearby enemies with bone fragments',
        cooldown: 3,
        currentCooldown: 0,
        range: 1,
        effects: [
  ...
  void_mage: {
    ...
    abilities: [
      ...
      },
      {
        ...
        name: 'Hex',
        type: AbilityType.Support,
        description: 'Places a hex on an enemy, reducing their damage output',
        cooldown: 4,
        currentCooldown: 0,
        range: 3,
        effects: [
  ...
  blood_shaman: {
    ...
    abilities: [
      ...
      },
      {
        ...
        name: 'Mark of Death',
        type: AbilityType.Support,
        description: 'Marks an enemy for death, making them take increased damage',
        cooldown: 4,
        currentCooldown: 0,
        range: 3,
        effects: [
  ...
  frost_elemental: {
    ...
    abilities: [
      ...
      },
      {
        ...
        name: 'Freezing Blast',
        type: AbilityType.Offensive,
        description: 'Unleashes a blast of freezing energy that damages and slows all nearby enemies',
        cooldown: 5,
        currentCooldown: 0,
        range: 3,
        effects: [
